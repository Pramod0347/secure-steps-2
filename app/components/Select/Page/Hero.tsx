            ...
            <div className="bg-white rounded-3xl md:rounded-full shadow-lg max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-5 grid-cols-1">
                ...
                <div className="flex items-center justify-center md:justify-end p-2 md:p-3">
                  <button
                    className="bg-gradient-to-r from-[#997CE1] via-[#E2B9E3] to-[#FA7BD6] text-white py-2 px-3 md:p-4 rounded-full flex items-center justify-center hover:opacity-90 transition-all gap-2"
