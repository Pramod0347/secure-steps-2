          ...
          <div className="p-6 md:p-10 space-y-8">
            ...
            <div className="pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 rounded-full bg-gradient-to-r from-[#997CE1] via-[#E2B9E3] to-[#FA7BD6] text-white flex items-center justify-center text-sm font-bold">15</span>
                Contact Us
              </h3>
